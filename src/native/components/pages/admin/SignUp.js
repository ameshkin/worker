    ...
    if(value) { // value is not values of form, but an object of the form after auto valildation
          ...
          this.setState(
            {
              ...
              alert: 1,
              loading: null,
              error: "Email not good",
              message: "Email not good message",
              type: 'error',
            });
        ...
        && value.password2.length > 5)
      {
        ...
        if( value.password === value.password2 ) {
          ...
          // TODO: ONE ENDPOINT should be zapier.  from zapier, we then hit this url.
          ...
          fetch(url, fetchData )
            ...
            .then((response) => {
              ...
              console.log("response form reigster api: ", response);
              if(response.error)
              {
                    ...
                    this.setState(
                      {
                        ...
                        modalVisible: true,
                        firebaseError: "Unknown error has occured",
                        alert: 1,
                        loading: null,
...
caused creazy errors
          ...
          error in catch:  [TypeError: _this2[type] is not a function. (In '_this2[type](routeName, res)', '_this2[type]' is undefined)]
