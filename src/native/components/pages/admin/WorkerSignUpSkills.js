...
import skillsDefaultJson from '../../../static/skills.json'
...
class WorkerSignUpSkill extends React.Component {
  ...
  handleChange = ( data ) => {
    ...
    console.log("going through skills: ", data);
    ...
    let setWithOptions = saveWorkerFirestoreGeneric('worker', { "skills": newstate })
      .then((response) => {
