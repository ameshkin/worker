 ...
 *
 ...
 1. sign up at a user SignUpComponent
 2. Auto Locate User
...
#### android
https://expo.io/artifacts/2d7c0e1a-0fcb-47ff-97e3-56d4bb385e5f
...
helper function getWorkerAsyncStorage: 
5:11:29 PM: [Error: Reference.child failed: First argument was an invalid path = "undefined". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"]
